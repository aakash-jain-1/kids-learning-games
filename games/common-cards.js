...
function initBuildInfo(){
  ...
  if(!el)return;
  fetch('https://api.github.com/repos/aakash-jain-1/kids-learning-games/commits/main').then(function(r){return r.json();}).then(function(d){el.textContent='Build: '+d.sha.slice(0,7)+' \xB7 '+d.commit.committer.date.slice(0,10);}).catch(function(){});
}
